...
class check_valid
{
    ...
    public static $int_set_regex = "/^[(]{1}(-{0,}[0-9]+,{1}){0,}(-{0,}[0-9]+)+[)]{1}$/";
    ...
    static function bool_check($string) { return $string == "true"; }

    static function bool_null_check($string) { if($string != null) return check_valid::bool_check($string); }
    ...
    static function vege_check($vege) { return (new \food\vege(null ,$vege))->name; }
